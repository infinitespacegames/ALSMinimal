...
ULocoBaseAnimInstanceIK::ULocoBaseAnimInstanceIK() {
...
void ULocoBaseAnimInstanceIK::NativeInitializeAnimation() {
...
// Called every frame 
void ULocoBaseAnimInstanceIK::NativeUpdateAnimation(float DeltaTimeX) {
	if (!Character) { return; }
...
void ULocoBaseAnimInstanceIK::FootIK_Implementation() {
...
void ULocoBaseAnimInstanceIK::RagdollIK_Implementation() {
	if (!bEnableFootIK) { bEnableFootIK = true; }
...
void ULocoBaseAnimInstanceIK::UpdateAnimationState() {

	// Character state
	if (!Character) { return; }

	ILocoBaseInterfaceABPIK::Execute_OnSetShowTraces((UObject*)this, Character->bShowTraces);
	ILocoBaseInterfaceABPIK::Execute_OnSetIsRagdoll((UObject*)this, Character->bIsRagdoll);

	// Character movement component state
	auto CharMov = Character->GetLocoBaseMovement();
	if (!CharMov) { return; }

	ILocoBaseInterfaceABPIK::Execute_OnSetStance((UObject*)this, CharMov->GetStance());
	ILocoBaseInterfaceABPIK::Execute_OnSetLocomotionMode((UObject*)this, CharMov->GetLocomotionMode());
}
