...
#include "LocoBaseStruct.generated.h"
...
struct LOCOBASE_API FCameraSettings {
 ...
 */
USTRUCT(BlueprintType)
struct LOCOBASE_API FCameraGaitSettings {
 ...
 */
USTRUCT(BlueprintType)
struct LOCOBASE_API FCameraStanceSettings {
 ...
 */
USTRUCT(BlueprintType)
struct LOCOBASE_API FCameraAimingSettings {
 ...
 */
USTRUCT(BlueprintType)
struct LOCOBASE_API FCameraTargetSettings {
 ...
 */
USTRUCT(BlueprintType)
struct LOCOBASE_API FPivotParameters {
 ...
 */
USTRUCT(BlueprintType)
struct LOCOBASE_API FTurnAnimations {
