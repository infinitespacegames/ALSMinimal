...
#include "LocoBaseInterfaceABP.generated.h"
...
class ULocoBaseInterfaceABP : public UInterface {
 ...
 */
class LOCOBASE_API ILocoBaseInterfaceABP {
...
public: 
	...
	UFUNCTION(BlueprintCallable, BlueprintNativeEvent, Category = "LocoBase|ABP_Interface")
